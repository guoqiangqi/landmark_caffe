...
def writeHD5(dataRows, outputPath, setTxtFilePATH, meanTrainSet=None, stdTrainSet=None , IMAGE_SIZE=60, mirror=False):
    ...
    if(not os.path.exists(os.path.dirname(setTxtFilePATH))):
        os.makedirs(os.path.dirname(setTxtFilePATH))
