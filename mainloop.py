...
DATA_PATH = os.path.join(ROOT, 'data')
CSV_TRAIN  = os.path.join(ROOT, 'wflw_data', 'landmark68.txt')
...
PATH_TO_WEIGHTS  = os.path.join('./Vanilla-40', 'caffeData', 'snapshots', 'snap_iter_5910000.caffemodel')
PATH_TO_DEPLOY_TXT = os.path.join('./Vanilla-40', 'ZOO', 'vanilla_deploy_large.prototxt')
...
if 'testErrorMini' in STEPS:
    with open('caffeData/testSetMini.pickle','r') as f:
